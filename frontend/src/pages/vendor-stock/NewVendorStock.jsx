      ...
      <div class="col-7 c-7-d mx-auto bg-pic">
        ...
        <form action="">
          <div class="text-center">
            <input type="number" class="col-4 vndr-ipt d-inline-block" placeholder="Vendor ID" name="vendor_id" value={newVendorStock.vendor_id} onChange={handleChange} />
            ...
            <input type="number" class="col-4 vndr-ipt d-inline-block" placeholder="Quantity" name="quantity" value={newVendorStock.quantity} onChange={handleChange} />
            <input type="number" class="col-4 my-4 vndr-ipt d-inline-block" placeholder="Amount" name="amount" value={newVendorStock.amount} onChange={handleChange} />
