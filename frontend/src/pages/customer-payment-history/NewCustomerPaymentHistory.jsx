      ...
      <div class="col-7 c-7-d mx-auto bg-pic">
        ...
        <form action="">
          <div class="text-center">
            <input type="number" class="col-7 vndr-ipt my-4 d-inline-block" placeholder="Customer ID"  name="customer_id" value={newCustomer.customer_id} onChange={handleChange}/>
